package com.armscreation.a_games.chain_beta;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_chain_beta);
    ...
    private void SingleChoice() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(com.armscreation.a_games.chain_beta.MainActivity.this);

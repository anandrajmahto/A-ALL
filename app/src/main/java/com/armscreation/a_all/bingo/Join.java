package com.armscreation.a_all.bingo;
...
public class Join extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_join_bingo);
        ...
        connect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!(input_room_codee.getText().toString().isEmpty())) {
                    ...
                    mDatabase.child("Bingo").child(input_room_code).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.getValue() != null) {
                                ...
                                mDatabase.child("Bingo").child(input_room_code).child("Moves").child("Turn").setValue("online");
                    ...
                    mDatabase.child("Bingo").child(input_room_code).child("Turn").addValueEventListener(new ValueEventListener() {
                        @SuppressLint("SetTextI18n")
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.getValue() != null) {
                    ...
                    mDatabase.child("Bingo").child(input_room_code).child("Moves").addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.getValue() != null) {
                                DataAdapter user = dataSnapshot.getValue(DataAdapter.class);
    ...
    private void UpdateData(String g) {
        ...
        mDatabase.child("Bingo").child(input_room_code).child("Moves").child("g1").setValue(g);
        DataAdapter user2 = new DataAdapter("1", "Connected");
        mDatabase.child("Bingo").child(input_room_code).child("Turn").setValue(user2);
 ...
 **/
    ...
    private void ResetData() {
        mDatabase.child("Bingo").child(input_room_code).child("Moves").child("g1").setValue(" ");
    ...
    public void onDestroy() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        //mDatabase.child("Bingo").child(input_room_code).child("Moves").child("Turn").setValue(" ");

        // mDatabase.child("Bingo").child(input_room_code).child("Moves").removeValue();
        mDatabase.child("Bingo").child(input_room_code).removeValue();
    }

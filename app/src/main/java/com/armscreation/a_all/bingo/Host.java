...
public class Host extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_host_bingo);
        ...
        hostbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDatabase.child("Bingo").child(nameofhost).child("Moves").child("Turn").setValue("online1");
                ...
                //  mDatabase.child("Bingo").child(nameofhost).setValue(user);
                mDatabase.child("Bingo").child(nameofhost).child("Moves").setValue(user1);
                mDatabase.child("Bingo").child(nameofhost).child("Turn").setValue(user2);
        ...
        mDatabase.child("Bingo").child(nameofhost).child("Turn").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mDatabase.child("Bingo").child(nameofhost).child("Moves").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    DataAdapter user = dataSnapshot.getValue(DataAdapter.class);
        ...
        mDatabase.child("Bingo").child(nameofhost).child("Moves").child("Turn").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
    ...
    private void UpdateData(String g) {
        mDatabase.child("Bingo").child(nameofhost).child("Moves").child("g1").setValue(g);
 ...
 **/
    ...
    private void ResetData() {
        mDatabase.child("Bingo").child(nameofhost).child("Moves").child("g1").setValue(" ");
    ...
    public void onDestroy() {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("Bingo").child(nameofhost).removeValue();
    }
